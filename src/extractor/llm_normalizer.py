...
Правила:
- Включай ТОЛЬКО гранты с активным open call — то есть приём заявок сейчас открыт или откроется в будущем. Если дедлайн уже прошёл или приём заявок закрыт — reject
...
- summary и why_relevant — на английском, кратко (2-3 предложения)
